...
/** Commands */
// these are auto-generated bindings for our rust backend, try not to break them
export const commands = {
  ...
  getAuthMetadata: () => typedError<AnyValue, AppError>(__TAURI_INVOKE('get_auth_metadata')),
  clearDiscordReportAuth: () => __TAURI_INVOKE<boolean>('clear_discord_report_auth'),
  loadDiscordReportAuth: () =>
    typedError<AnyValue, AppError>(__TAURI_INVOKE('load_discord_report_auth')),
  saveDiscordReportAuth: (auth: AnyValue) =>
    typedError<boolean, AppError>(__TAURI_INVOKE('save_discord_report_auth', { auth })),
  discordReportingConfigured: () => __TAURI_INVOKE<boolean>('discord_reporting_configured'),
  startDiscordLogin: (inApp: boolean | null) =>
    typedError<AnyValue, AppError>(__TAURI_INVOKE('start_discord_login', { inApp })),
  openDiscordDeepLink: (url: string) =>
    typedError<boolean, AppError>(__TAURI_INVOKE('open_discord_deep_link', { url })),
  verifyDiscordAuth: (loginToken: string) =>
    typedError<AnyValue, AppError>(__TAURI_INVOKE('verify_discord_auth', { loginToken })),
  pollDiscordLogin: (sessionId: string) =>
    typedError<AnyValue, AppError>(__TAURI_INVOKE('poll_discord_login', { sessionId })),
  fetchDiscordAnnouncements: () =>
    typedError<AnyValue, AppError>(__TAURI_INVOKE('fetch_discord_announcements')),
  fetchDiscordPoll: () => typedError<AnyValue, AppError>(__TAURI_INVOKE('fetch_discord_poll')),
  submitDiscordPollVote: (pollId: string, optionIds: string[]) =>
    typedError<AnyValue, AppError>(
      __TAURI_INVOKE('submit_discord_poll_vote', { pollId, optionIds }),
    ),
  openDiscordPoll: (
    title: string,
    description: string,
    ...
    typedError<AnyValue, AppError>(
      __TAURI_INVOKE('open_discord_poll', {
        title,
        description,
        options,
        allowMultiple,
  ...
  closeDiscordPoll: (pollId: string | null) =>
    typedError<AnyValue, AppError>(__TAURI_INVOKE('close_discord_poll', { pollId })),
  ...
  getRuntimeInfo: () => __TAURI_INVOKE<AnyValue>('get_runtime_info'),
  ...
  checkSession: () => typedError<AnyValue, AppError>(__TAURI_INVOKE('check_session')),
  ...
  getRobloxProfile: (context: ProfileRequest) =>
    typedError<AnyValue, AppError>(__TAURI_INVOKE('get_roblox_profile', { context })),
  ...
  loadRendererSettings: () =>
    typedError<AnyValue, AppError>(__TAURI_INVOKE('load_renderer_settings')),
  saveRendererSettings: (settings: AnyValue) =>
    typedError<boolean, AppError>(__TAURI_INVOKE('save_renderer_settings', { settings })),
  loadProfileSecrets: () => typedError<AnyValue, AppError>(__TAURI_INVOKE('load_profile_secrets')),
  saveProfileSecrets: (data: AnyValue) =>
    typedError<AnyValue, AppError>(__TAURI_INVOKE('save_profile_secrets', { data })),
  clearProfileSecrets: (profileId: string | null) =>
    typedError<boolean, AppError>(__TAURI_INVOKE('clear_profile_secrets', { profileId })),
  getJobs: () => typedError<AnyValue, AppError>(__TAURI_INVOKE('get_jobs')),
  ...
  scanAndReplaceMultipleStrings: (pid: number, replacements: { [key in string]: string }) =>
    typedError<{ [key in string]: MemoryInjectionResult }, string>(
      __TAURI_INVOKE('scan_and_replace_multiple_strings', {
        pid,
        replacements,
      }),
    ),
  ...
  patchAssetPermissions: (assetId: string, universeId: string, cookie: string, csrfToken: string) =>
    typedError<boolean, AppError>(
      __TAURI_INVOKE('patch_asset_permissions', {
        assetId,
        universeId,
        cookie,
        csrfToken,
  ...
  setAssetPrivacy: (assetId: string, privacyStatus: string, cookie: string, csrfToken: string) =>
    typedError<boolean, AppError>(
      __TAURI_INVOKE('set_asset_privacy', {
        assetId,
        privacyStatus,
        cookie,
        csrfToken,
  ...
  findAssetByName: (cookie: string, assetType: string, name: string, groupId: string | null) =>
    typedError<string | null, AppError>(
      __TAURI_INVOKE('find_asset_by_name', {
        cookie,
        assetType,
        name,
        groupId,
  ...
  pushToStudio: (replacementsMap: string | null, pluginPort: string | null) =>
    typedError<boolean, AppError>(
  ...
  getPairingStatus: () => __TAURI_INVOKE<AnyValue>('get_pairing_status'),
  getPluginBridgePort: () => __TAURI_INVOKE<number | null>('get_plugin_bridge_port'),
  getStudioHealthStatus: () => __TAURI_INVOKE<AnyValue>('get_studio_health_status'),
  getStudioAssetSnapshots: () => __TAURI_INVOKE<AnyValue>('get_studio_asset_snapshots'),
};

/* Types */
export type AnyValue = string | null;
...
// wraps the raw invoke calls so we get nice typed errors instead of random crashes
